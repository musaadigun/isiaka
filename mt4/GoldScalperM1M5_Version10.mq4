...
// every change. Version 10 = this build.
//
...
void ManagePosition()
{
   ...
   if(movement<g_posMaxAdv)
   {
      ...
      if(persistAdv) PersistTicketState(ticket);
   }
...
void CreatePanel()
{
   ...
   PanelText("Title","XVISION  |  GOLD SCALPER M1/M5 V10",PANEL_LABEL_X,22,
             PANEL_TITLE,13);
