...
// every change. Version 5 = this build.
//
...
input double MaxShockExhaustion        = 1.00;  // stand down above this shock+exhaustion; 1 = off [0.45]
...
int EvaluateMomentum(string &blocker)
{
   ...
   if(MaxShockExhaustion<1.0 && g_modeShock+g_modeExhaustion>MaxShockExhaustion)
...
void CreatePanel()
{
   ...
   PanelText("Title","XVISION  |  GOLD SCALPER M1/M5 V5",PANEL_LABEL_X,22,
             PANEL_TITLE,13);
...
int OnInit()
{
   ...
   Print("GoldScalper: entry gates active - burst>=",DoubleToString(CusumTrigger,2),
         ...
         (MaxShockExhaustion<1.0?", shock+exh<="+DoubleToString(MaxShockExhaustion,2):""),
