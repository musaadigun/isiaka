...
Current build: **Version 4**.

## Repository layout

| Path | What it is |
|---|---|
| `mt4/GoldScalperM1M5_Version4.mq4` | The EA. Compile in MetaEditor, attach to XAUUSD M1. |
...
1. Copy `mt4/GoldScalperM1M5_Version4.mq4` to `MQL4/Experts`, compile
