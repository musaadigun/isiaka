...
| Path | What it is |
|---|---|
| `mt4/GoldScalperM1M5_Version11.mq4` | The EA. Compile in MetaEditor, attach to XAUUSD M1. |
...
Entry-engine gates are inputs too (all with an off switch), plus the
M5 trend filter:
...
1. Copy `mt4/GoldScalperM1M5_Version11.mq4` to `MQL4/Experts`, compile
