...
Current build: **Version 6**.

## Repository layout

| Path | What it is |
|---|---|
| `mt4/GoldScalperM1M5_Version6.mq4` | The EA. Compile in MetaEditor, attach to XAUUSD M1. |
...
1. Copy `mt4/GoldScalperM1M5_Version6.mq4` to `MQL4/Experts`, compile
