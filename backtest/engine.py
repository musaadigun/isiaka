#!/usr/bin/env python3
"""Tick-replay backtester for GoldScalperM1M5 (mirrors EA Version 10).
...
class Config:
    ...
    # Exit engine. Mirrors EA v10: the ONLY exits are the user's SL, TP,
    ...
    # momentum module - mirrors EA v10 defaults (permissive; 0 = gate off)
